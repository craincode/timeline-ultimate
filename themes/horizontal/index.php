...
function timeline_um_body_horizontal($post_id): string
{
    ...
    if ($wp_query->have_posts()) :
        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
            ...
            $timeline_um_thumb = wp_get_attachment_image_src(
                get_post_thumbnail_id(get_the_ID()),
                $timeline_um_items_thumb_size
            );
            ...
            if ($categories) {
                foreach ($categories as $category) {
                    $category_output .= '<a href="' . get_category_link($category->term_id) . '" title="' . esc_attr(
...
function timeline_um_body_ajax_horizontal(): never
{
...
add_action('wp_ajax_timeline_um_body_ajax_horizontal', 'timeline_um_body_ajax_horizontal');
add_action('wp_ajax_nopriv_timeline_um_body_ajax_horizontal', 'timeline_um_body_ajax_horizontal');
