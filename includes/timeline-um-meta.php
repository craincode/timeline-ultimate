...
function meta_boxes_timeline_um()
{
    add_meta_box(
        'timeline_um_metabox',
        __('Timeline Ultimate Options', 'timeline_um'),
        'meta_boxes_timeline_um_input',
        'timeline_um'
    );
}
...
function meta_boxes_timeline_um_input($post)
{
    ...
    <div class="para-settings">
        <div class="option-box">
            ...
            <p class="option-info">Copy this shortcode and paste on page or post where you want to display timeline,
                <br/>Use PHP code to your themes file to display timeline.</p>
            <textarea cols="50" rows="1" style="background:#bfefff" onClick="this.select();">[timeline_um <?php
                echo 'id="' . $post->ID . '"'; ?> ]</textarea>
            <br/><br/>
            PHP Code:<br/>
            <textarea cols="50" rows="1" style="background:#bfefff" onClick="this.select();"><?php
                echo '<?php echo do_shortcode("[timeline_um id=';
                echo "'" . $post->ID . "' ]";
                echo '"); ?>'; ?></textarea>
        </div>
        ...
        <ul class="box">
            ...
            <li style="display: block;" class="box1 tab-box active">
                ...
                <div class="option-box">
                    ...
                    <select name="timeline_um_items_thumb_size">
                        ...
                        if ($timeline_um_items_thumb_size == "none") {
                            echo "selected";
                        } ?>>None
                        </option>
                        <option value="thumbnail" <?php
                        if ($timeline_um_items_thumb_size == "thumbnail") {
                            echo "selected";
                        } ?>>Thumbnail
                        </option>
                        <option value="medium" <?php
                        if ($timeline_um_items_thumb_size == "medium") {
                            echo "selected";
                        } ?>>Medium
                        </option>
                        <option value="large" <?php
                        if ($timeline_um_items_thumb_size == "large") {
                            echo "selected";
                        } ?>>Large
                        </option>
                        <option value="full" <?php
                        if ($timeline_um_items_thumb_size == "full") {
                            echo "selected";
                        } ?>>Full
                        </option>
                ...
                <div class="option-box">
                    ...
                    if (!empty($timeline_um_items_thumb_max_hieght)) {
                        echo $timeline_um_items_thumb_max_hieght;
                    } else {
                        echo "";
                    } ?>"/>
                </div>
                ...
                <div class="option-box">
                    ...
                    <select name="timeline_um_items_author">
                        <option value="no" <?php
                        if ($timeline_um_items_author == "no") {
                            echo "selected";
                        } ?>>No
                        </option>
                        <option value="yes" <?php
                ...
                <div class="option-box">
                    ...
                    <select name="timeline_um_items_categories">
                        <option value="no" <?php
                        if ($timeline_um_items_categories == "no") {
                            echo "selected";
                        } ?>>No
                        </option>
                        <option value="yes" <?php
            ...
            <li style="display: none;" class="box2 tab-box">
                ...
                <div class="option-box">
                    ...
                    <p class="option-info"></p>
                    <input type="text" name="timeline_um_middle_circle_bg" id="timeline_um_middle_circle_bg"
                           value="<?php
                           if (!empty($timeline_um_middle_circle_bg)) {
                               echo $timeline_um_middle_circle_bg;
                           } else {
                               echo "#28c8a8";
                           } ?>"/>
                </div>
                <div class="option-box">
                    ...
                    <p class="option-info"></p>
                    <input type="text" name="timeline_um_middle_line_bg" id="timeline_um_middle_line_bg" value="<?php
                    if (!empty($timeline_um_middle_line_bg)) {
                        echo $timeline_um_middle_line_bg;
                    } else {
                        echo "#28c8a8";
                    } ?>"/>
                </div>
                ...
                <div class="option-box">
                    ...
                    <p class="option-info"></p>
                    <input type="text" name="timeline_um_items_title_color" id="timeline_um_items_title_color"
                           value="<?php
                           if (!empty($timeline_um_items_title_color)) {
                               echo $timeline_um_items_title_color;
                           } else {
                               echo "#28c8a8";
                           } ?>"/>
                </div>
                <div class="option-box">
                    ...
                    <p class="option-info"></p>
                    <input type="text" name="timeline_um_items_title_font_size" placeholder="ex:14px number with px"
                           id="timeline_um_items_title_font_size" value="<?php
                    if (!empty($timeline_um_items_title_font_size)) {
                        echo $timeline_um_items_title_font_size;
                    } else {
                        echo "14px";
                    } ?>"/>
                </div>
                ...
                <div class="option-box">
                    ...
                    <p class="option-info"></p>
                    <input type="text" name="timeline_um_items_content_color" id="timeline_um_items_content_color"
                           value="<?php
                           if (!empty($timeline_um_items_content_color)) {
                               echo $timeline_um_items_content_color;
                           } else {
                               echo "#fff";
                           } ?>"/>
                </div>
                <div class="option-box">
                    ...
                    <p class="option-info"></p>
                    <input type="text" name="timeline_um_items_content_font_size"
                           id="timeline_um_items_content_font_size" value="<?php
                    if (!empty($timeline_um_items_content_font_size)) {
                        echo $timeline_um_items_content_font_size;
                    } else {
                        echo "13px";
                    } ?>"/>
                </div>
            ...
            <li style="display: none;" class="box3 tab-box">
                <div class="option-box">
                    ...
                    <ul class="content_source_area">
                        ...
                        <li>
                            <input class="timeline_um_content_source" name="timeline_um_post_content"
                                   id="timeline_um_post_content" type="radio" value="full" <?php
                        ...
                        <li>
                            <input class="timeline_um_content_source" name="timeline_um_post_content"
                                   id="timeline_um_post_excerpt" type="radio" value="excerpt" <?php
                            ...
                            <div class="timeline_um_post_excerpt content-source-box">
                                ...
                                Excrept Length:
                                <input type="text" placeholder="25" size="4" name="timeline_um_post_excerpt_count"
                                       value="<?php
                                       if (!empty($timeline_um_post_excerpt_count)) {
                                           echo $timeline_um_post_excerpt_count;
                                       } ?>"/>
                                <br/>
                                Read More Text:
                                <input type="text" placeholder="Read More..." size="10"
                                       name="timeline_um_post_excerpt_text" value="<?php
                                if (!empty($timeline_um_post_excerpt_text)) {
                                    echo $timeline_um_post_excerpt_text;
                                } ?>"/>
                ...
                <div class="option-box">
                    ...
                    foreach ($post_types as $post_type) {
                        if ($post_type == 'post') {
                            ...
                            <?php
                            if (isset($timeline_um_posttype[$post_type])) {
                                echo "checked";
                            } ?>
                            <?php
                ...
                <div class="option-box">
                    ...
                    <p class="option-info"></p>
                    <ul class="content_source_area">
                        <li><input class="timeline_um_content_source" name="timeline_um_content_source"
                                   id="timeline_um_content_source_latest" type="radio" value="latest" <?php
                            if ($timeline_um_content_source == "latest") {
                                echo "checked";
                            } ?> /> <label for="timeline_um_content_source_latest">Display from Latest Published</label>
                            <div class="timeline_um_content_source_latest content-source-box">Slider items will query
                                from latest published post.
                            </div>
                        </li>

                        <li><input class="timeline_um_content_source" name="timeline_um_content_source"
                                   id="timeline_um_content_source_older" type="radio" value="older" <?php
                            if ($timeline_um_content_source == "older") {
                                echo "checked";
                            } ?> /> <label for="timeline_um_content_source_older">Display from Older Published</label>
                            <div class="timeline_um_content_source_older content-source-box">Slider items will query
                                from older published post.
                            </div>
                        </li>

                        <li><input class="timeline_um_content_source" name="timeline_um_content_source"
                                   id="timeline_um_content_source_featured" type="radio" value="featured" <?php
                            if ($timeline_um_content_source == "featured") {
                                echo "checked";
                            } ?> /> <label for="timeline_um_content_source_featured">Display from Featured Post</label>

                            <div class="timeline_um_content_source_featured content-source-box">Slider items will query
                                from featured marked post.
                            </div>
                        </li>

                        <li><input class="timeline_um_content_source" name="timeline_um_content_source"
                                   id="timeline_um_content_source_year" type="radio" value="year" <?php
                            if ($timeline_um_content_source == "year") {
                                echo "checked";
                            } ?> /> <label for="timeline_um_content_source_year">Display from Only Year</label>

                            <div class="timeline_um_content_source_year content-source-box">Slider items will query from
                                a year.
                                <input type="text" size="7" class="timeline_um_content_year"
                                       name="timeline_um_content_year" value="<?php
                                if (!empty($timeline_um_content_year)) {
                                    echo $timeline_um_content_year;
                                } ?>" placeholder="2014"/>
                            </div>
                        </li>
                        ...
                        <li><input class="timeline_um_content_source" name="timeline_um_content_source"
                                   id="timeline_um_content_source_month" type="radio" value="month" <?php
                            if ($timeline_um_content_source == "month") {
                                echo "checked";
                            } ?> /> <label for="timeline_um_content_source_month">Display from Month</label>

                            <div class="timeline_um_content_source_month content-source-box">Slider items will query
                                from Month of a year. <br/>
                                <input type="text" size="7" class="timeline_um_content_month_year"
                                       name="timeline_um_content_month_year" value="<?php
                                if (!empty($timeline_um_content_month_year)) {
                                    echo $timeline_um_content_month_year;
                                } ?>" placeholder="2014"/>
                                <input type="text" size="7" class="timeline_um_content_month"
                                       name="timeline_um_content_month" value="<?php
                                if (!empty($timeline_um_content_month)) {
                                    echo $timeline_um_content_month;
                                } ?>" placeholder="06"/>
                            </div>
                        </li>
