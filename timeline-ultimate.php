...
add_action('admin_menu', 'timeline_um_menu_init');


	
function timeline_um_menu_help(){
	include('timeline-um-help.php');	
}
...
function timeline_um_menu_init()
	{

			
		add_submenu_page('edit.php?post_type=timeline_um', __('Help & Upgrade','menu-wpt'), __('Help & Upgrade','menu-wpt'), 'manage_options', 'timeline_um_menu_help', 'timeline_um_menu_help');
